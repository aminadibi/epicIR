...
get_input <- function(age0 = 40,
  ...
  input$agent$p_prevalence_age <- c(rep(0, 40), c(1154.0915,
                                                  1107.3335,
                                                  1072.057,
                                                  1056.554,
                                                  1057.0175,
  ...
  input_help$agent$p_prevalence_age <- "Age pyramid at baseline (taken from UN World Provision Prospects 2022)"
  input$agent$p_prevalence_age <- input$agent$p_prevalence_age/sum(input$agent$p_prevalence_age)
  input_ref$agent$p_prevalence_age <- "https://population.un.org/wpp/Download/Standard/MostUsed/"
  ...
  input$agent$p_bgd_by_sex <- cbind(male = c(0.014761504,
                                            rep(0.00225857, 4),
                                            rep(0.002045004, 5),
                                            rep(0.002453003, 5),
                                            rep(0.005911442, 5),
  ...
  input_ref$agent$p_bgd_by_sex <- "Life table for 2015 based on WHO https://apps.who.int/gho/data/view.searo.60760?lang=en"
  ...
  input$agent$l_inc_betas <- t(as.matrix(c(intercept = -2.4-input$global_parameters$closed_cohort*100, y = 0.02, y2 = -0.0020))) # intercept is the result of model calibration,
  ...
  input$smoking$minimum_smoking_prevalence <- 0.01
  ...
  input$exacerbation$ln_rate_betas <- t(as.matrix(c(intercept = 1.8, female = 0, age = 0.04082 * 0.1, fev1 = -1.5, smoking_status = 0.7, gold1 = 0.3 , gold2 = -0.3 , gold3 = 0.08 , gold4 = -0.35 , diagnosis_effect = 0)))
