...
get_input <- function(age0 = 40,
  ...
  input$agent$l_inc_betas <- t(as.matrix(c(intercept = -2.33-input$global_parameters$closed_cohort*100, y = 0.02, y2 = -0.0023))) # intercept is the result of model calibration,
