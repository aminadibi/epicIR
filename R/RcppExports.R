...
Cset_settings_var <- function(name, value) {
    .Call(`_epicIR_Cset_settings_var`, name, value)
}
...
Cget_runtime_stats <- function() {
    .Call(`_epicIR_Cget_runtime_stats`)
}
...
mvrnormArma <- function(n, mu, sigma) {
    .Call(`_epicIR_mvrnormArma`, n, mu, sigma)
}

Xrexp <- function(n, rate) {
    .Call(`_epicIR_Xrexp`, n, rate)
}
...
Cset_input_var <- function(name, value) {
    .Call(`_epicIR_Cset_input_var`, name, value)
}
...
get_sample_output <- function(year, sex) {
    .Call(`_epicIR_get_sample_output`, year, sex)
}

Cget_agent <- function(id) {
    .Call(`_epicIR_Cget_agent`, id)
}
...
Cget_output_ex <- function() {
    .Call(`_epicIR_Cget_output_ex`)
}

Ccreate_agents <- function() {
    .Call(`_epicIR_Ccreate_agents`)
}
...
Cget_agent_events <- function(id) {
    .Call(`_epicIR_Cget_agent_events`, id)
}
...
Cget_events_by_type <- function(event_type) {
    .Call(`_epicIR_Cget_events_by_type`, event_type)
}
...
Cget_all_events_matrix <- function() {
    .Call(`_epicIR_Cget_all_events_matrix`)
}

Callocate_resources <- function() {
    .Call(`_epicIR_Callocate_resources`)
}

Cget_pointers <- function() {
    .Call(`_epicIR_Cget_pointers`)
}

Cdeallocate_resources <- function() {
    .Call(`_epicIR_Cdeallocate_resources`)
}

Cdeallocate_resources2 <- function() {
    .Call(`_epicIR_Cdeallocate_resources2`)
}

Cinit_session <- function() {
    .Call(`_epicIR_Cinit_session`)
}

Cmodel <- function(max_n_agents) {
    .Call(`_epicIR_Cmodel`, max_n_agents)
}
